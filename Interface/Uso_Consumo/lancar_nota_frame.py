...
class LancarNotaFrame(ctk.CTkFrame):
    """
    Frame individual para operação de Lançar Nota no módulo de Uso e Consumo.
    ...
    def __init__(self, parent):
        ...
        self.lbl_titulo = ctk.CTkLabel(
            self.card,
            text="📄  LANÇAMENTO DE NOTAS FISCAIS",
        ...
        self.lbl_desc = ctk.CTkLabel(
            self.card,
            text="Digite ou bipe a chave de acesso da nota fiscal (NFe/XML) de uso e consumo.",
        ...
        self.entry_chave = ctk.CTkEntry(
            self.card,
            placeholder_text="🔑  Digite ou bipe a chave de acesso da Nota Fiscal...",
    ...
    def iniciar_processamento(self):
        ...
        if not chave:
            messagebox.showwarning("Chave Não Informada", "Por favor, digite ou bipe a chave de acesso da nota fiscal.")
        else:
            messagebox.showinfo("Lançamento Iniciado", f"Lançamento da Nota Fiscal iniciado!\nChave: {chave}")
