...
class CadastrarProdutosFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent):
        ...
        self.lbl_desc = ctk.CTkLabel(
            self.card,
            text="Digite ou bipe a chave de acesso da nota/documento para cadastrar os produtos.",
        ...
        self.lbl_chave = ctk.CTkLabel(
            self.card,
            text="CHAVE DE ACESSO PARA CADASTRO",
    ...
    def iniciar_processamento(self):
        ...
        if not chave:
            messagebox.showwarning("Chave Não Informada", "Por favor, digite ou bipe a chave de acesso para cadastrar os produtos.")
        else:
            messagebox.showinfo("Cadastro Iniciado", f"Processamento de Cadastro de Produtos iniciado!\nChave: {chave}")
